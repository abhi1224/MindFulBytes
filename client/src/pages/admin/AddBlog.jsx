...
import { assets, blogCategories } from '../../assets/MindFulBytes-assests/assets'
    ...
    <>
      <form 
        ...
        <div className="bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded">
          ...
          <label htmlFor="image">
            <img src={!image ? assets.upload_area :URL.createObjectURL(image)} alt="upload area image" className='mt-2 h-16 rounded cursor-pointer' />
