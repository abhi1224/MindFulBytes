...
import { comments_data } from '../../assets/MindFulBytes-assests/assets';
          ...
          >
            <table className='w-full text-sm text-gray-500'>
              <thead className='text-xs text-gray-700 text-left uppercase'>
                <tr>
                  <th scope='col' className='px-6 py-5'>Blog Title & Comment</th>
                  <th scope='col' className='px-6 py-5 max-sm:hidden'>Date</th>
