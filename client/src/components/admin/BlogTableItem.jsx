...
import cross_icon from '../../assets/MindFulBytes-assests/cross_icon.svg'
    ...
    <>
      <tr className="border-y border-gray-300">
        ...
        <td className='px-2 py-4 flex text-xs gap-3'>
          ...
          <img className='w-8 hover:scale-110 transition-all cursor-pointer' src={cross_icon} alt="cross image" />
        </td>
      </tr>
    </>
  )
